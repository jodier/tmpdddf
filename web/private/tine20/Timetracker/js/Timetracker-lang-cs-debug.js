...
: "Vytvořit nebo aktualizovat sdílené oblíbené položky sledování času"
...
: [
 ...
 ,"seznamy pracovních výkazů"
 ,"seznamů pracovních výkazů"
...
: [
  "seznam časových fondů"
 ,"seznamy časových fondů"
 ,"seznamů časových fondů"
...
: "Oprávnění přidávat pracovní výkazy k tomuto časovému fondu"

, "View All"
: "Prohlížet vše"

, "The grant to view Timesheets of other users"
: "Oprávnění prohlížet pracovní výkazy ostatních uživatelů"

, "Book All"
: "Zakládat vše"

, "The grant to add Timesheets for other users"
: "Oprávnění přidávat pracovní výkazy ostatním uživatelům"

, "Manage Clearing"
: "Spravovat platby"

, "The grant to manage clearing of Timesheets"
: "Oprávnění spravovat vyúčtování pracovních výkazů"

, "Export"
: "Exportovat"

, "The grant to export Timesheets of Timeaccount"
: "Oprávnění exportovat pracovní výkazy časového fondu"

, "Manage All"
: "Spravovat vše"

, "Includes all other grants"
: "Zahrnuje všechna ostatní oprávnění"
...
, "Could not save {0}."
: "Nepodařilo se uložit {0}."

, "Booking deadline for this Timeaccount has been exceeded."
: "Nejzazší termín rezervace tohoto časového fondu byl překročen."
...
, "Billable Timesheets"
: "Účtovatelných výkazů"

, "Total Time"
: "Celkový čas"

, "Time of Billable Timesheets"
: "Čas účtovatelných výkazů"
...
: "Konfigurace exportu pracovních výkazů do ODS"

, "Use this configuration for the timesheet ODS export."
: "Použít tuto konfiguraci pro export pracovních výkazů do ODS."
