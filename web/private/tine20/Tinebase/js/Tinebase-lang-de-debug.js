...
: "Nur ASCII-Zeichen sind in Psaswörtern erlaubt."
...
: "Es ist nicht erlaubt diesen Ordner zu löschen. Bitte definieren sie zuvor einen anderen Ordner für interne Kontakte!"

, "System Container"
: "System Ordner"

, "Password Policy Violation"
: "Verletzung der Passwortrichtlinie"

, "This is a system container which could not be deleted!"
: "Das ist ein Systemcontainer, der nicht gelöscht werden darf!"

, "Generic System Exception"
: "Genereller Systemfehler"
...
: "Ein Fehler ist aufgetreten, dass Programm wurde unerwartet beendet."
...
: "Veröffentlicht unter verschiedenen"

, "Open Source Licenses"
: "Open Source Lizenzen"

, "with the help of our"
: "mit der Hilfe von unseren"
...
: "Das Feld ist im Profil lesbar"

, "Edit"
: "Bearbeiten"

, "The field is editable part of the profile"
: "Das Feld kann im Profil bearbeitet werden"
...
: "Es sind keine Anwendungen aktiviert. Bitte wenden Sie sich an Ihren Administrator."
...
: "Ihre letzte Aktion wurde möglicherweise nicht korrekt ausgeführt."
...
: "Mit dem Senden eines Fehlerberichtes helfen Sie mit, die Software zu verbessern. Bitte beschreiben Sie, was genau Sie gemacht haben, bevor der Fehler aufgetreten ist."

, "Description"
: "Beschreibung"

, "Send Contact Information"
: "Kontaktinformation senden"
...
: "Ihr Bericht wurde gesendet. Vielen Dank für ihre Mithilfe!"

, "Please restart your browser now!"
: "Bitte starten Sie Ihren Browser neu!"
...
: "Der Eintrag wurde von jemand anderem geändert während Sie daran arbeiteten. Sie müssen aktualisieren und die Änderungen erneut durchführen."
...
: "Der Server kann Ihre Anfrage leider Aufgrund einer temporären Überlastung, Wartungsarbeiten oder Fehlkonfiguration nicht beantworten. Bitte versuchen Sie es später noch einmal oder kontaktieren Sie Ihren Administrator."
...
: "Ihre Eingabedaten sind ungültig. Bitte tragen Sie korrekte Daten ein."

, "Connection lost, please check your network!"
: "Verbindungsabbruch, bitte überprüfen Sie ihre Netzwerkeinstellungen!"
...
: "Es ist eine Zeitüberschreitung beim Bearbeiten der Anfrage aufgetreten. Eventuell müssen Sie den Browser neu laden und es noch einmal versuchen."

, "No Response"
: "Keine Antwort"

, "Sorry, the Server did not respond any data. Please reload your browser, try again or contact your administrator."
: "Leider konnte der Server auf Ihre Anfrage nicht antworten. Bitte aktualisieren Sie Ihren Browser und versuchen Sie es anschliessend noch einmal. Im erneuten Fehlerfall kontaktieren Sie bitte Ihren Administrator."

, "Out of Resources"
: "Keine Ressourcen mehr"

, "Sorry, the Server stated a \"memory exhausted\" condition. Please contact your administrator."
: "Entschuldigung, der Server hat keinen Arbeitsspeicher mehr zur Verfügung. Bitte kontaktieren Sie Ihren Administrator."

, "No Role Memberships"
: "Keine Mitgliedschaften in Rollen"

, "Your user account has no role memberships. Please contact your administrator."
: "Ihr Benutzerkonto besitzt keine Mitgliedschaften in Rollen. Bitte kontaktieren Sie Ihren Administrator."
...
: "Tine 2.0 macht die Zusammenarbeit im Unternehmen einfacher und angenehmer. Helft uns, Tine 2.0 weiter zu verbessern. Wir freuen uns über Eure Ideen und spannende Diskussionen."
...
: "Wir brauchen regelmäßiges Feedback von Tine 2.0 Benutzern um die nächste Version noch besser an Eure Bedürfnisse anzupassen. Helft uns und Euch mit Eurer Teilnahme:"
...
: "Ihr Browser wird von Tine 2.0 nicht unterstützt."

, "Browser incompatible?"
: "Browser inkompatibel?"

, "You are using an unrecognized browser. This could result in unexpected behaviour."
: "Sie benutzen einen unbekannten Browser. Das könnte zu unerwartetem Verhalten führen."

, "You might try one of these browsers:"
: "Sie könnten einen dieser Browser ausprobieren:"
...
: "Anmeldung erfolgreich. {0} wird geladen..."
...
: "Ihre Benutzername/Passwort-Kombination ist leider falsch!"

, "Errors"
: "Fehler"

, "Please fix the errors noted."
: "Bitte beheben Sie die gekennzeichneten Fehler"
...
: "Dem Browser erlauben, Webkit Desktop-Benachrichtigungen anzuzeigen"

, "Install web app"
: "Installiere Web-Applikation"

, "Install Tine 2.0 as web app in your browser."
: "Tine 2.0 als Web-Applikation im Browser installieren."
...
: "Ihr Passwort ist abgelaufen. Bitte setzen Sie ein neues Benutzer-Passwort:"
...
: "Die neuen Passwörter stimmen nicht überein. Bitte wiederholen Sie die Eingabe."
...
: "Fataler Fehler: Client-Update fehlgeschlagen. Bitte kontaktieren Sie Ihren Administrator und aktualisieren Sie Ihre Browser-Ansicht."
...
: "Sie haben alle benötigten Informationen eingegeben. Wenn Sie nun den Fertig Knopf drücken, wird ihnen eine Bestätigungsemail zugesandt."
...
: "Bitte wählen Sie eine Bilddatei (gif/png/jpeg)"

, "Upload Failed"
: "Fehler beim Hochladen"

, "Could not upload image. Please notify your Administrator"
: "Das Bild konnte nicht Hochgeladen werden. Bitte informieren Sie ihren Administrator"
...
: "Das Bild konnte nicht geladen werden. Bitte informieren Sie ihren Administrator"
...
: "Alle Seiten auswählen ({0} Einträge)"
...
: "Das Fenster mit dem sie arbeiten möchten ist im Hintergrund. Mit Ihrem Browser kann man keine Fenster automatisch in der Vordergrund hohlen. Sie müssen daher das Fenster auf anderem Wege in der Vordergrund hohlen. Bitte beschweren Sie sich bei ihrem Browser Hersteller!"
...
, "Updating Grants"
: "Berechtigungen werden gesichert"

, "Error"
: "Fehler"

, "You are not allowed to remove all admins for this container!"
: "Sie dürfen nicht alle Administratoren entfernen!"

, "The grant to read records of this container"
: "Das Recht, Einträge in diesem Container zu lesen"

, "The grant to add records to this container"
: "Das Recht, Einträge zu diesem Container hinzuzufügen"

, "The grant to edit records in this container"
: "Das Recht, Einträge in diesem Container zu bearbeiten"

, "Delete"
: "Löschen"

, "The grant to delete records in this container"
: "Das Recht, Einträge in diesem Container zu löschen"

, "The grant to export records from this container"
: "Das Recht, Einträge in diesem Container zu exportieren"

, "Sync"
: "Sync"

, "The grant to synchronise records with this container"
: "Das Recht, Einträge in diesem Container zu synchronisieren"

, "Admin"
: "Admin"

, "The grant to administrate this container"
: "Das Recht, diesen Container zu administrieren"

, "Free Busy"
: "Frei / Belegt"

, "The grant to access free busy information of events in this calendar"
: "Das Recht, zu Termine in diesem Kalender Frei/Belegt-Informationen angezeigt zu bekommen"

, "Private"
: "Privat"

, "The grant to access records marked as private in this container"
: "Das Recht, private Einträge in diesem Container zu lesen"
...
: "Sie haben nicht das Recht, den {0} '{1}' auszuwählen:"

, "{0} grant is required for desired action"
: "Das {0} Recht ist für diese Aktion erforderlich"
...
: "Einstellungen für Anwendung {0} bearbeiten"
...
, "Merging Records..."
: "Führe Einträge zusammen"

, "Merge Failed"
: "Zusammenführung fehlgeschlagen"

, "The merge succeeded, but the duplicate {0} could not be deleted."
: "Das Zusammenführen war erfolgreich, doch die Dublette vom Typ: \"{0}\" konnte nicht gelöscht werden."

, "Merge {0}, prefer First"
: "Zusammenführung von {0}, bevorzuge den ersten"

, "Merge {0}, prefer Second"
: "Zusammenführung von {0}, bevorzuge den zweiten"
...
: "Der Datensatz, den Sie versucht haben, hinzuzufügen, existiert möglicherweise bereits."
...
: "Zusammenführen, existierende Werte behalten"

, "Merge, keeping my details"
: "Zusammenführen, neue Werte behalten"

, "Keep existing record and discard mine"
: "Den existierenden Datensatz behalten und den neuen verwerfen"
...
: "Möchten Sie diesen {0} wirklich löschen?"
...
, "Could not delete {0}."
: "Konnte {0} nicht löschen."

, "Resolve Duplicate {0} Suspicion"
: "Dublettenverdacht {0} lösen"
...
: "Wählen Sie eine Exportdefinition"
...
: "Datei und Format wählen"

, "Choose Import File"
: "Importdatei wählen"

, "Please choose the file that contains the records you want to add to Tine 2.0"
: "Bitte wählen Sie die Datei, die die Datensätze enthält, die Sie zu Tine 2.0 hinzufügen wollen"

, "Select file containing your {0}"
: "Wählen Sie die Datei mit Ihren {0}"

, "What should the file you upload look like?"
: "Wie soll die Datei, die Sie hochladen, aussehen?"
...
: "Tine 2.0 versteht nicht alle Dateien, die Sie möglicherweise hochladen möchten. Eventuell müssen Sie manuell die Datei so anpassen, dass sie von Tine 2.0 verarbeitet werden kann."

, "Following you find a list of all supported import formats and a sample file, how Tine 2.0 expects your file to look like."
: "Nachfolgend finden Sie eine Liste mit allen Import-Formaten und eine Beispieldatei, anhand derer Sie sehen, wir die Datei aussehen sollte."
...
, "Set Import Options"
: "Import-Optionen setzen"

, "Select {0} to add you {1} to:"
: "Wählen {0} hinzufügen {1} zu:"
...
: "Es gibt {0} {1}, die bereits existieren."
...
: "Bearbeite Konfliktdaten"

, "No conflict to resolve"
: "Kein Konflikt, der gelöst werden muss"

, "(This is record {0} in your import file)"
: "(Das ist Datensatz {0} in Ihrer Importdatei)"
...
: "{0} Datensätze hatten Fehler und wurden verworfen."

, "In total we found {0} records in your import file."
: "Wir haben {0} Datensätze in der Import-Datein gefunden."

, "{0} of them will be added as new records into: \"{1}\"."
: "Es werden {0} als neue Datensätze hinzugefügt: \"{1}\"."

, "{0} of them where identified as duplicates."
: "Es wurden {0} Datensätze als Dubletten identifiziert."

, "From the identified duplicates {0} will be merged into the existing records."
: "Es werden {0} Dubletten mit existierenden Kontaken zusammengeführt."

, "From the identified duplicates {0} will be discarded."
: "Es werden {0} Dubletten verworfen."

, "All records will be tagged with: \"{0}\" so you can find them easily."
: "Alle Datensätze werden mit \"{0}\" getaggt, damit sie einfach gefunden werden können."

, "{0} records have failures and will be discarded."
: "{0} Datensätze haben Fehler und werden verworfen."
...
: "Den Wert aus allen Datensätzen löschen"

, "Undo change for all selected records"
: "Änderung für alle selektierten Einträge rückgängig machen"

, "Different Values"
: "Verschiedene Werte"

, "This field has different values. Editing this field will overwrite the old values."
: "Dieses Feld hat verschiedene Werte. Das Bearbeiten wird die alten Werte überschreiben."

, "Do you really want to change these {0} records?"
: "Wollen sie diese {0} Datensätze ändern?"

, "Applying changes"
: "Führe Änderungen durch"

, "You edited {0} {1}."
: "Sie haben {0} {1} bearbeitet."

, "{0} {1} have been updated properly."
: "{0} {1} wurden erfolgreich aktualisiert."

, "{0} {1} has been updated properly."
: "{0} {1} wurde erfolgreich aktualisiert."

, "{0} {1} have invalid data after updating. These {1} have not been changed."
: "{0} {1} haben invalide Daten nach der Aktualisierung. Diese {1} wurden nicht geändert."

, "{0} {1} has invalid data after updating. This {1} has not been changed."
: "{0} {1} hat invalide Daten nach der Aktualisierung. Dieser {1} wurde nicht geändert."
...
: "Sie müssen die rot markierten Felder korrigieren um die Konfiguration speichern zu können"

, "Saving of preferences failed."
: "Speichern der Einstellungen fehlgeschlagen."

, "There are no preferences for this application."
: "Es gibt derzeit keine Einstellungen für diese Anwendung."
...
: "Bitte wählen Sie eine Datei mit einer der folgenden Dateiendungen:"

, "Searching..."
: "Suche ..."

, "Could not upload file. Filesize could be too big. Please notify your Administrator. Max upload size: "
: "Datei konnte nicht hochgeladen werden. Eventuell ist sie zu groß. Bitte informieren Sie Ihren Administrator. Maximale Dateigröße: "
...
: "Achtung: Es sind noch weitere Filter gesetzt!"
...
: "Zeige erweiterte Filter immer an"

, "Show records that match to one of the following filters"
: "Zeige Datensätze die zu einem der folgenden Filter passen"

, "or alternatively"
: "oder alternativ"

, "Add alternative filter"
: "Alternativen Filter hinzufügen"
...
: [
  "Ihre Anzeige ist durch {0} Kriterium limitiert:"
 ,"Ihre Anzeige ist durch {0} Kriterien limitiert:"
...
: "Keine {0} gefunden. Bitte überprüfen Sie ihre Filterkriterien, Ansichtsoptionen oder die {1}, in denen Sie suchen."
...
: "Es ist ihnen nicht erlaubt alle Seiten auf einmal zu löschen"

, "Do you really want to delete the selected record ({0})?, Do you really want to delete the selected records ({0})?"
: [
  "Wollen Sie wirklich den ausgewählten Eintrag löschen ({0})?"
 ,"Wollen Sie wirklich die ausgewählten Einträge löschen ({0})?"
...
: "Diese Ansicht als Favorit speichern"

, "Favorite not Saved"
: "Favorit wurde nicht gespeichert"

, "You have to supply a shorter name! Names of favorite can only be up to 40 characters long."
: "Sie müssen einen kürzeren Namen für den Favoriten eingeben. Der Name kann maximal 40 Zeichen lang sein."

, "You have to supply a name for the favorite!"
: "Sie müssen einen Namen für den Favoriten eingeben!"

, "Title"
: "Bezeichnung"

, "Shared Favorite (visible by all users)"
: "Gemeinsame Favoriten (sichtbar für alle Benutzer)"
...
, "Overwrite Favorite"
: "Favorit überschreiben"

, "Do you really want to delete the favorite \"{0}\"?"
: "Möchten sie den Favoriten \"{0}\" wirklich löschen?"
...
: "Wollen Sie den Favoriten \"{0}\" überschreiben?"

, "Overwriting Favorite \"{0}\""
: "Überschreibe Favorit \"{0}\""

, "Could not save Favorite"
: "Konnte Favoriten nicht speichern"

, "Your current view does not support favorites"
: "Ihre derzeitige Ansicht unterstützt keine Favoriten"
...
: "Es sind fehlerhafte Verknüpfungen vorhanden. Bitte prüfen Sie diese vorm Speichern."

, "The maximum number of {0} with the type {1} is reached. Please change the type of this relation"
: "Die maximale Anzahl von {0} mit Typ {1} wurde erreicht. Bitte ändern Sie den Typ der Verknüpfung."
...
: "Der Datensatz, den Sie verknüpfen möchten, ist bereits verknüpft. Bitte bearbeiten Sie die bereits vorhandene Verknüpfung."

, "You tried to link a record with itself. This is not allowed!"
: "Sie versuchen den Datensatz mit sich selbst zu verknüpfen. Dieser Vorgang ist nicht erlaubt."

, "The {1} \"{2}\" is already used in the Field \"{0}\" and can be linked only once!"
: "Der {1} \"{2}\" wird bereits in Feld \"{0}\" benutzt und kann nur einmal verknüpft werden!"
...
: "Das Tag zu den folgenden Einträgen hinzufügen:"
...
: "Bitte wählen Sie die Tags, die entfernt werden sollen"

, "Add a new personal tag"
: "Neuen persönlichen Tag hinzufügen"

, "Add New Personal Tag"
: "Neuen persönlichen Tag hinzufügen"

, "Please note: You create a personal tag. Only you can see it!"
: "Bitte beachten: Einen persönlichen Tag können nur Sie sehen!"
...
: [
  "Ausgewählten Tag wirklich löschen?"
 ,"Ausgewählte Tags wirklich löschen?"
...
: [
  "Der ausgewählte Tag wird gelöscht und verschwindet bei allen Einträgen"
 ,"Die ausgewählten Tags werden gelöscht und verschwinden bei allen Einträgen"
...
: "Konnte Tag(s) nicht löschen."

, "Notice"
: "Beachten Sie"

, "The minimum tag length is three."
: "Ein Tag muss mindestens aus 3 Zeichen bestehen."

, "Could not create tag."
: "Konnte Tag nicht erzeugen."

, "Could not update tag."
: "Konnte Tag nicht aktualisieren."
...
: "Es wurden keine Tags bei den ausgewählten Datensätzen gefunden"
...
: "Neue Zeitzone setzen..."

, "Rename {0}"
: "{0} umbenennen"

, "Manage {0} Permissions"
: "{0} Berechtigungen verwalten"
...
: "Bitte den Namen für neue {0} eingeben:"

, "No {0} added"
: "Kein {0} hinzugefügt"

, "You have to supply a {0} name!"
: "Sie sollten einen Namen für {0} angeben!"

, "Creating {0}..."
: "Einrichten {0}..."

, "Please enter the new name of the {0}:"
: "Bitte den Namen für {0}: eingeben:"

, "Not renamed {0}"
: "{0} nicht umbenannt"

, "Do you really want to delete the {0} \"{1}\"?"
: "Möchten Sie {0} \"{1}\" wirklich löschen?"

, "Manage Permissions for {0} \"{1}\""
: "Rechte für {0} :\"{1}\" verwalten"

, "Properties for {0} \"{1}\""
: "Eigenschaften von {0} \"{1}\""

, "New version of Tine 2.0 available"
: "Eine neue Version von Tine 2.0 ist verfügbar."

, "Version \"{0}\" of Tine 2.0 is available."
: "Die Version \"{0}\" von Tine 2.0 ist verfügbar."

, "It's a critical update and must be installed as soon as possible!"
: "Dieses wichtige Update sollte umgehend installiert werden!"
...
: "Die Zeitzone, in der Zeiten in Tine 2.0 angezeigt werden sollen."

, "The language of the Tine 2.0 GUI."
: "Die Sprache der Tine 2.0 Oberfläche."

, "Default Application"
: "Standardanwendung"

, "The default application to show after login."
: "Die Anwendung, die standardmäßig nach dem Login aufgerufen wird."

, "Window Type"
: "Fenstertyp"

, "You can choose between modal windows or normal browser popup windows."
: "Sie können zwischen modalen und normalen PopUp-Fenstern wählen."

, "Confirm Logout"
: "Ausloggen bestätigen"

, "Show confirmation dialog on logout."
: "Bestätigungsdialog beim Ausloggen anzeigen."
...
: "Tine 2.0 muss aktualisiert werden oder ist noch nicht komplett installiert."

, "Please wait or contact your administrator"
: "Bitte warten Sie oder kontaktieren Sie den Administrator"
