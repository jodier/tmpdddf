...
: "přidat, editovat a smazat leady"

, "manage shared lead folders"
: "spravovat sdílené složky leadů"

, "Create new shared lead folders"
: "Vytvořit novou sdílenou složku leadů"

, "manage shared leads favorites"
: "spravovat sdílené oblíbené položky leadů"

, "Create or update shared leads favorites"
: "Vytvořit nebo aktualizovat sdílené oblíbené položky leadů"
...
: "Změnit typ na Zákazník"

, "Responsible"
: "Odpovědná osoba"

, "Change type to Responsible"
: "Změnit typ na Odpovědná osoba"

, "Change type to Partner"
: "Změnit typ na Partner"

, "Change contact type"
: "Změnit typ kontaktu"

, "Search for Contacts to add ..."
: "Hledat kontakty pro přidání"
...
: "Nemáte oprávnění ke spuštění aplikace Úkoly nebo aplikace není povolena."

, "You do not have the run right for the Sales application or it is not activated."
: "Nemáte oprávnění ke spuštění aplikace Prodej nebo aplikace není povolena."

, "Enter short name"
: "Zadejte stručný název"
...
, "Unlink selected {0}"
: "Zrušit odkaz(y) na vybraný/é {0}"

, "Edit {0}"
: "Editovat {0}"

, "Edit selected {0}"
: "Editovat vybraný/é {0}"
...
: "Hledat produkty pro přidání ..."

, "No Tasks to display"
: "Žádné úkoly ke zobrazení"
...
: "Úroveň činností o kterých chcete být informováni."

, "Send Notifications Emails for own actions"
: "Odesílat e-maily s upozorněním pro vlastní činnosti."

, "Get notifications emails for actions you did yourself"
: "Dostávat e-maily s upozorněním pro činnosti, které jste udělal(a)."

, "Default Favorite"
: "Výchozí oblíbené položky CRM"

, "The default favorite which is loaded on crm startup"
: "Výchozí oblíbené položky, které jsou načteny při spuštění CRM."

, "All leads I have read grants for"
: "Všechny leady, které jsem oprávněn číst"
