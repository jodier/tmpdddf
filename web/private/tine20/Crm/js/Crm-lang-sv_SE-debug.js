...
: "lägg till, redigera och ta bort leads"

, "manage shared lead folders"
: "hantera delade lead mappar"

, "Create new shared lead folders"
: "Skapa nya delade lead mappar"

, "manage shared leads favorites"
: "hantera delade leads favoriter"

, "Create or update shared leads favorites"
: "Skapa eller uppdatera delade leads favoriter"
...
: "Välj Lead till att lägga till kontakter till"

, "Please select the attenders' role"
: "Välj deltagarnas roll"
...
: "Ändra typ till Ansvarig"

, "Change type to Partner"
: "Ändra typ till Partner"

, "Change contact type"
: "Ändra kontakt typ"

, "Search for Contacts to add ..."
: "Sök på kontakter att lägga till ..."
...
: "Du har inte kör rättigheter för Uppgifts applikation eller är det inte aktiverat"

, "You do not have the run right for the Sales application or it is not activated."
: "Du har inte kör rättigheter för Sälj applikatio så är det inte aktiverat."
...
: "Sök på produkter att lägga till ..."
...
: "Få Notifierings E-postmeddelanden"

, "The level of actions you want to be notified about."
: "Nivån på åtgärder som du vill bli informerad om."

, "Send Notifications Emails for own actions"
: "Skicka meddelanden e-post för egna handlingar"

, "Get notifications emails for actions you did yourself"
: "Få Notifierings e-post för åtgärder som du gjorde själv"

, "Default Favorite"
: "Standard Favorit"

, "The default favorite which is loaded on crm startup"
: "Standard favoriten som laddas på crm start"

, "All leads I have read grants for"
: "Alla leads Jag har läs rättigheter för"

, "Last modified by me"
: "Senast uppdaterad av mig"

, "All leads that I have last modified"
: "Alla leads jag senast har modifierat"

, "My leads"
: "Mina leads"

, "All leads that I am responsible for"
: "Alla leads som jag är ansvarig för"

, "Leads with overdue tasks"
: "Leads med förfallna arbetsuppgifter"
