...
: "hantera delade adressböcker"

, "Create new shared addressbook folders"
: "Skapa nya delade adressböcker-mappar"

, "manage shared addressbook favorites"
: "hantera delade adressboks favoriter"

, "Create or update shared addressbook favorites"
: "Skapa eller uppdatera delade adressboks favoriter"

, "Contact duplicate check fields"
: "Kontakta duplicerade check områden"
...
: "Dessa fält kontrolleras när en ny kontakt skapas. Om en post med samma data inom de områden hittas, en dubblett undantag skapas."

, "Contact salutations available"
: "Kontakt hälsningsfraser tillgängliga"
...
: "Möjliga kontakt hälsningar. Observera att ytterligare värden kan påverka andra adressböcker på export eller synkronisering."

, "Parsing rules for addresses"
: "Parsing regler för adresser"

, "Path to a XML file with address parsing rules."
: "Väg till en XML-fil med adress parsing regler."

, "Uploaded new contact image."
: ""

, "%s's personal addressbook"
: "%s personliga adressbok"
...
: "Kontakter importerade på  ###CURRENTDATE### vid ###CURRENTTIME### av ###USERFULLNAME###"
...
: "Antingen {0} eller {1} måste anges"

, "Paste address"
: "Analysera adress"

, "Please paste an address that should be parsed:"
: "Klistra in en adress som ska analyserad:"
...
: "Förhandsgranska denna länken i dialogrutan redigera."
...
: "Standard adressboken för nya kontakter"

, "Default Favorite"
: "Standard Favorit"

, "The default favorite which is loaded on addressbook startup"
: "Standardinställningen favoriten som laddas vid addressbook start"
...
: "Alla kontakter Jag har Läsrättigheter för"

, "My company"
: "Mitt företag"

, "All coworkers in my company"
: "Alla medarbetare i mitt företag"

, "My contacts"
: "Mina kontakter"

, "All contacts in my Addressbooks"
: "Alla kontakter i mina Adressböcker"

, "Last modified by me"
: "Senast ändrad av mig"

, "All contacts that I have last modified"
: "Alla kontakter som Jag senast har ändrat"
