...
: "Usuń wszystkich, istniejących użytkowników i grupy"
...
: "Przejście z SQL na LDAP usunie wszystkie, istniejące konta użytkowników, grupy oraz role. Czy na pewno chcesz przełączyć konta na LDAP?"

, "Backend"
: "W tle"

, "Initial Admin User"
: "Początkowy administrator"

, "Initial admin login name"
: "Początkowy login administratora"

, "Initial admin Password"
: "Początkowe hasło administratora"
...
: "Spróbuj podzielić nazwę użytkownika"
...
: "Dołącz domenę do loginu"

, "Accounts storage"
: "Konta"

, "Default user group name"
: "Domyślna nazwa grupy użytkownika"

, "Default admin group name"
: "Domyślna nazwa grupy administratora"
...
, "User Search Scope"
: "Zakres wyszukiwania użytkowników"
...
, "Group Search Scope"
: "Zakres wyszukiwania grupy"

, "Password encoding"
: "Metoda kodowania hasła"

, "Use Rfc 2307 bis"
: "Stosuj RFC 2307 aż do"
...
: "Unikalny atrybut grupy"

, "User UUID Attribute name"
: "Unikalny atrybut użytkownika"
...
, "Minimum word chars"
: "Minimalna ilość znaków w słowie"
...
: "Przekieruj URL (jeśli pusty, wyświetl ekran logowania)"

, "Redirect Always (if No, only redirect after logout)"
: "Zawsze przekieruj (w przypadku Nie, przekieruj po wylogowaniu)"

, "Redirect to referring site, if exists"
: "Przekieruj do powiązanej strony, jeśli istnieje"

, "Save config and install"
: "Zapisz konfigurację i zainstaluj"
...
: "Brak uprawnień zapisu do pliku konfiguracyjnego"
...
: "Poddomeny (oddzielone przecinkiem)"

, "Notifications service address"
: "Adres e-mail usługi powiadamiania"

, "Notification Username"
: "Przypomnienie nazwy użytkownika"

, "Notification Password"
: "Przypomnienie hasła"

, "Notifications local client (hostname or IP address)"
: "Powiadomienia, klient lokalny (nazwa hosta albo adres IP)"

, "SIEVE"
: "FILTR"

, "MySql Hostname"
: "Nazwa hosta dla MySQL"
...
: "Przygotowywanie testów środowiska..."

, "There could not be found any {0}. Please try to change your filter-criteria, view-options or the {1} you search in."
: "Nie znaleziono {0}. Proszę spróbować zmienić kryteria filtrowania, opcje podglądu albo {1}, w którym szukasz."

, "Check"
: "Sprawdzane składniki"
...
: "Przeczytałem postanowienia licencji i je akceptuję"

, "License Agreement"
: "Warunki udzielenia licencji"

, "I have read the privacy agreement and accept it"
: "Przeczytałem postanowienia poufności i je akceptuję"

, "Privacy Agreement"
: "Postanowienia poufności"

, "Accept Terms and Conditions"
: "Akceptuję warunki i postanowienia."
