...
, "Go to {0} login"
: "Aller à la page de login de {0}"

, "uninstall"
: "désinstaller"

, "Do you really want to uninstall the application(s)?"
: "Êtes-vous sûr de vouloir désinstaller l'application?"

, "This may take a while"
: "Cela peut être long"

, "Dependency Violation"
: "Violation de dépendances"

, "Delete all existing users and groups"
: "Supprimer tous les groupes et utilisateurs existants"
...
: "Basculer du SQL en LDAP supprimera tous les comptes, groupes et rôles. Êtes-vous sûrs de vouloir basculer en authentification LDAP?"
...
: "Essayez de séparer le nom d'utilisateur"
...
: "Forme canonique du compte"

, "Account domain name "
: "Nom de domaine du compte "

, "Account domain short name"
: "Nom court de domaine du compte"
...
: "Ajouter le domaine au nom de connexion"

, "Accounts storage"
: "Stockage des comptes"

, "Default user group name"
: "Nom du groupe utilisateur par défaut"

, "Default admin group name"
: "Nom du groupe administrateur par défaut"
...
, "User Search Scope"
: "Champs de recherche des utilisateurs"
...
, "Group Search Scope"
: "Champs de recherche des groupes"

, "Password encoding"
: "Encodage du mot de passe"

, "Use Rfc 2307 bis"
: "Utiliser la  Rfc 2307 bis"
...
: "Nom d'attribut de groupe (GUID)"

, "User UUID Attribute name"
: "Nome d'attribut utilisateur (UUID)"
...
: "Activer le paramétrage des mots de passe"
...
: "Nombre minimum de lettres en majuscule"
...
: "URL de redirection (si laissé vide, redirigera vers la page de connexion)"

, "Redirect Always (if No, only redirect after logout)"
: "Toujours rediriger (si Non, ne rediriger qu'après la déconnexion)"

, "Redirect to referring site, if exists"
: "Redirection vers le site de référence, s'il existe"

, "Save config and install"
: "Enregistrer la configuration et installer"
...
, "Filestore Path"
: "Chemin du stockage des fichiers"

, "Addressbook Map panel"
: "Carte du carnet d'adresse"
...
: "Le ifchier de configuration n'est pas modifiable"
...
, "Cyrus Admin"
: "Administrateur Cyrus"

, "Cyrus Admin Password"
: "Mot de passe de l'adminstrateur Cyrus"
...
: "Domaines secondaires (séparés par une virgule)"

, "Notifications service address"
: "Adresse du service de notification"

, "Notification Username"
: "Nom des notifications"

, "Notification Password"
: "Mot de passe des notifications"

, "Notifications local client (hostname or IP address)"
: "Notifications du client local (nom d'hôte ou adresse IP)"
...
: "Impossible de trouver {0}. Veuillez modifier votre filtre, votre mode d'affichage ou le {1} dans lequel vous cherchez"
...
, "Run setup tests"
: "Lancer les tests d'installation"

, "Ignore setup tests"
: "ignorer les tests d'installation"
